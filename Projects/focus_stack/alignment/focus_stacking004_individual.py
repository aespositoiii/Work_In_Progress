from stacking_funcs_001 import get_images, laplace_threshold, mask_blur
import sys
import cv2 as cv
...
blurred_align = mask_blur(laplace_align, max_blur, j=101)
for n in range(50):
        blurred_align = mask_blur(blurred_align, max_blur, n)
print(i)
print('a')
cv.imshow('window', img)
cv.waitKey(5000)
