from stacking_funcs_016_1 import import_describe, laplace_threshold, mask_blur, registration, image_sort, reg_comb
...
comb = reg_comb(images, order, thresh=30, norm_blur=11, n_iter=50, exp=3, warp_mode=cv.MOTION_EUCLIDEAN, number_of_iterations=1000, termination_eps=1e-3)
