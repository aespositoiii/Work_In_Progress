...
#######################################      Generate the filtered image previews     ###########################################
        ...
        def preview_result():
            ...
            if process_select.get() == "Gabor":
                ...
                image_selection[image_selection > 0] = 1
                ...
                result = aesop.aesops_Filter(image_selection, kernel_size_start=parameter_values[0], kernel_size_end=parameter_values[1], kernel_step=parameter_values[2], series=series_val, steps=parameter_values[4])
