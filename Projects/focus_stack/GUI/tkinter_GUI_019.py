...
def batch_process(process_summary_filename, image_filenames, process_summary_dict):
            ...
            if process_select.get() == "Log_Gabor":
                ...
                def trunc_func():
                    ...
                    if truncate.get() == True:
                        ...
                        truncate_scale.place(x=20, y=50+len(parameter_list)*70)
                ...
                truncate_histogram.place(x=20, y=20+len(parameter_list)*70)
    ...
    process_ops_dict =   {      "Gabor": [
                                ...
                                "Miscellaneous":
                                        [   [   'Invert',
                                            ...
                                            [   ['Scale', ' - scale for resizing', .01, 1, .01]]],
...
def open_batch_proc():
    ...
    def image_select_window():
        ...
        def batch_process_images():
            ...
            batch_proc_win.destroy()
#-----------------------------------------------------------------------------------------------------------------------
            batch_process(process_summary_filename, image_filenames, process_summary_dict)
